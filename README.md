...
The code, investigations brought to you by [Ilyes](https://www.linkedin.com/in/ilyes-m-195012a9/) and [Thierry](https://www.linkedin.com/in/tsjanaudy/) with the help of [Gemini](https://gemini.google.com/) and [Claude](https://chat.chatbotapp.ai/).
...
Some Gemini generated docs: [the maths behind MPC](./Gemini/MPC-Maths.pdf) and [what is ZKP](./Gemini/ZKP.pdf).
